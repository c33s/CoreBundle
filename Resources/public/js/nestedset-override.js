 ...
 * ================================================
 * 
 * This overrides/enhances the nested tree to provide drag&drop behavior for 
 * sortable lists.
 * 
...
;(function ($, window, undefined) {
    ...
    var pluginName = 'agen$nestedTreeOverride';
...
//    		(isRootNode) ? node.addClass('ui-helper-hidden') : '';
    	...
    	_dropActionName: function(ui, $droppable) {
            ...
            if (droppableOffset <= draggableX && draggableX < droppableOffset + droppableHeight * .4 ) { 
                return 'before';
            } else if (droppableOffset + droppableHeight * .6 < draggableX && draggableX <= droppableOffset + droppableHeight ) {
                return 'after';
            }
