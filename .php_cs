...
'-braces', 
// [PSR-2] The body of each structure MUST be enclosed by braces. Braces should be properly placed. Body of braces should be properly indented.
'elseif', 
...
'function_call_space', 
// [PSR-2] When making a method or function call, there MUST NOT be a space between the method or function name and the opening parenthesis.
...
// [PSR-2] In method arguments and method call, there MUST NOT be a space before each comma and there MUST be one space after each comma.
'multiple_use', 
// [PSR-2] There MUST be one use keyword per declaration.
'parenthesis', 
// [PSR-2] There MUST NOT be a space after the opening parenthesis. There MUST NOT be a space before the closing parenthesis.
'php_closing_tag', 
...
// [symfony] Operator => should not be arounded by multi-line whitespaces.
'duplicate_semicolon', 
// [symfony] Remove duplicated semicolons.
'empty_return', 
// [symfony] A return statement wishing to return nothing should be simply "return".
'extra_empty_lines', 
// [symfony] Removes extra empty lines. 
'include',
// [symfony] Include and file path should be divided with a single space. File path should not be placed under brackets.
...
'operators_spaces', 
// [symfony] Operators should be arounded by at least one space.
'phpdoc_params', 
// [symfony] All items of the @param phpdoc tags must be aligned vertically.
...
'-strict', 
// [contrib] Comparison should be strict. Warning! This could change code behavior.
'-strict_param', 
// [contrib] Functions should be used with $strict param. Warning! This could change code behavior.
